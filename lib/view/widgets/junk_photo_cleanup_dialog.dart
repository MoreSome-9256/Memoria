...
class _JunkPhotoCleanupDialogState extends State<JunkPhotoCleanupDialog> {
  ...
  void _clearAll() {
    ...
    setState(() {
      if (_activeReasonLabel == null) {
        ...
        _selectedPhotoIds.removeAll(visibleCandidates.map((item) => item.photoId));
      }
    });
  }
  ...
  List<JunkPhotoCleanupCandidate> get _filteredCandidates {
    ...
    return widget.report.candidates.where((candidate) {
      return candidate.reasons.any((reason) => reason.label == activeReasonLabel);
                    ...
                    return entries.map(
                      (entry) => ChoiceChip(
                        ...
                        onSelected: (_) {
                          setState(() {
                            _activeReasonLabel =
                                _activeReasonLabel == entry.key ? null : entry.key;
                          });
                        },
                      ),
                    );
              ...
              ConstrainedBox(
                ...
                child: GridView.builder(
                  ...
                  itemBuilder: (context, index) {
                    ...
                    final selected =
                        _selectedPhotoIds.contains(candidate.photoId);
                    final heroTag = 'junk-cleanup-${candidate.photoId}';
                    return Container(
                      ...
                      child: Column(
                        ...
                        children: [
                                ...
                                Positioned(
                                  ...
                                  child: Material(
                                    ...
                                    child: Checkbox(
                                      value: selected,
                                      onChanged: (checked) =>
                                          _toggle(candidate.photoId, checked),
                          ...
                          InkWell(
                            ...
                            onTap: () => _toggle(candidate.photoId, !selected),
                            child: Padding(
